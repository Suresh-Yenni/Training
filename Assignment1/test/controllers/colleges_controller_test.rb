...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { established_year: @college.established_year, name: @college.name } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { established_year: @college.established_year, name: @college.name } }
